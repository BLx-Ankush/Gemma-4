...
const REQUEST_TIMEOUT_MS = 160000; // 160s: offline VEDA ~77s + MIRROR ~20s + headroom
...
function showSpinner(msg = "Processing…") {
  ...
  spinnerHintTimer = setTimeout(() => {
    if (!spinner.hidden) {
      spinnerMsg.textContent = "Still processing… Offline AI is running entirely on this device. Please wait up to 2 minutes.";
    }
  }, 10000);
